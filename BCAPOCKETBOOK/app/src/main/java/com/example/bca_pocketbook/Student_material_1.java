...
public class Student_material_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_material_1);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(Student_material_1.this, student_material_2.class);
                i.putExtra("c",course);
                i.putExtra("sem",sem);
                i.putExtra("s",subject);
                startActivity(i);

                Toast.makeText(Student_material_1.this,course+"__"+sem+"__"+subject, Toast.LENGTH_SHORT).show();
