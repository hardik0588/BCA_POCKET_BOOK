...
public class Admin_Homework extends AppCompatActivity {
...
//    StorageReference storageReference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin__homework);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        editText= findViewById(R.id.multxt);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (txt.isEmpty()) {
                    ...
                    if (!txt.isEmpty()) {
                        insertStudentData(txt);
                        startActivity(new Intent(getApplicationContext(), MainActivity.class));


                    } else {
                        Toast.makeText(Admin_Homework.this, "please fullfill all detail", Toast.LENGTH_SHORT).show();
                    }
                }
            }
            ...
            private void insertStudentData(String txt) {
                //String string = textView.getText().toString();
              //  putPDF putPDF = new putPDF(string);
                //studentDbRef.child("Home Work").child(c).child(s).child(sub).child(databaseReference.push().getKey()).setValue(putPDF);
                homework putPDF= new homework(editText.getText().toString());
                databaseReference=FirebaseDatabase.getInstance().getReference("MyPDF").child("Home Work").child(course).child(sem).child(subject);
                databaseReference.child(databaseReference.push().getKey()).setValue(txt);
                Toast.makeText(Admin_Homework.this, "Data Success Fully Added ", Toast.LENGTH_SHORT).show();
            }
        });
