...
public class student_homework_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView = findViewById(R.id.multxt);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(student_homework_1.this, student_homework_2.class);
                i.putExtra("c",course);
                i.putExtra("sem",sem);
                i.putExtra("s",subject);
                startActivity(i);

                Toast.makeText(student_homework_1.this,course+"__"+sem+"__"+subject, Toast.LENGTH_SHORT).show();
