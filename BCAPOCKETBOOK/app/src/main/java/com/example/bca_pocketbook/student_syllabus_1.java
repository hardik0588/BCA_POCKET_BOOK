...
public class student_syllabus_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_syllabus__1);
        ...
        btn=findViewById(R.id.btnRetrieveOP);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(student_syllabus_1.this, student_syllabus_2.class);
                i.putExtra("c",course);
                i.putExtra("sem",sem);
                i.putExtra("s",subject);
                startActivity(i);

                Toast.makeText(student_syllabus_1.this,course+"__"+sem+"__"+subject, Toast.LENGTH_SHORT).show();
