...
public class Admin_Syllabus extends AppCompatActivity {
    Button LogOutBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin__syllabus);
        ...
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        databaseReference.child("Syllabus").child(c).child(s).child(sub).child(databaseReference.push().getKey()).setValue(putPDF);
                        Toast.makeText(Admin_Syllabus.this, "file upload.", Toast.LENGTH_SHORT).show();
