...
public class Admin_OldPaper extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin__old_paper);
...
*/
        ...
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        databaseReference.child("old paper").child(c).child(s).child(sub).child(databaseReference.push().getKey()).setValue(putPDF);
                        Toast.makeText(Admin_OldPaper.this, "file upload.", Toast.LENGTH_SHORT).show();
    ...
    public void student_material1(View view) {
        startActivity(new Intent(getApplicationContext(), student_material_2.class));
        finish();
    }
}